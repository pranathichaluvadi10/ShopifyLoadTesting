...
public class NavigateToProductPageFlow extends Flow
{
    ...
    public boolean execute() throws Throwable
    {
        while (!breaker.reached())
        {
            if (ProductListingPage.instance.is())
            {
                ...
                if (ProductListingPage.instance.is())
                {
                	System.out.println("pranathicount");
                    viewProductDetails();
                    System.out.println("HelloCheck2");
                }
            }
            else {
            	break;
            ...
            {
            	System.out.println("HelloCheck3");
    ...
    {
    	//System.out.println("HelloCheck12");
        ...
        System.out.println("...........Check1" + viewCount);
