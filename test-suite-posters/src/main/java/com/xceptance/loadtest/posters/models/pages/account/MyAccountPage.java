...
public class MyAccountPage extends GeneralPages
{
    ...
    public void validate()
    {
        ...
        Assert.assertTrue("Expected my account page title", Page.find().byCss("h1.account-title").exists());
    ...
    public boolean is()
    {
        ...
        return Page.find().byCss("h1.account-title").exists();
        //.return Page.find().byCss("//h1").exists();
    }
