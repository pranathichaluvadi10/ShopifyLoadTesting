...
public class ProductListingPage extends GeneralPages
{
  ...
  //  public final Pagination pagination = Pagination.instance;
    ...
    public String getCategoryType()
    {
    	...
    	String categoryType = RegExUtils.getFirstMatch(Context.getPage().getUrl().toString(), "\\/search?q=\\/([^/]*)", 1);
    ...
    public String getCategoryId()
    {
    	...
    	String categoryId = RegExUtils.getFirstMatch(pagingScript, "\\/search?q=\\/([^/]*)", 1);
